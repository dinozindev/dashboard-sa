...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { name: "description", content: "Dashboard interativo de áreas de frete das lojas Aricanduva e Suzano." },
      { name: "author", content: "Lovable" },
      { property: "og:title", content: "Dashboard de Frete — Aricanduva x Suzano" },
      { property: "og:description", content: "Áreas de atendimento, regras de preço e cálculo de frete por faixa de peso." },
